...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
	 <br><br><br><br>
      <h1 class="w3-text-teal">What we Do</h1>
      <p>A professional network service is a type of social network service that is focused solely on interactions 
	  and relationships of a business nature rather than including personal, nonbusiness interactions .<br><br>      A professional network service is used by business individuals to establish and maintain professional contacts and a way to 
	  either find work or get ahead in career as well as gain resources and opportunities for networking<br>
	  Some professional network services do not only help promote the business, but can also help in connecting to other people. Those services may include a specific phone and/or Internet company or a company that helps to connect with other businesses. According to the Society for New Communications Research (SNCR), there are at least nine online professional networks that are being used.</div>
  ...
  <div class="w3-row">
    <div class="w3-twothird w3-container">
      <h1 class="w3-text-teal">What You want to do </h1>
      <p>If you are having account you can  <a href="">Login</a> <br>Or else you can Create now <a href="">Create</a></div>
  <!--  <div class="w3-third w3-container">
      <p class="w3-border w3-padding-large w3-padding-32 w3-center">AD</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">AD</p>
    </div>
